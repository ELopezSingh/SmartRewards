...
function MenuItem({ icon, label, onPress }: MenuItemConfig & { onPress: () => void }) {
  return (
...
export default function ProfileScreen() {
  ...
  const miembroDesde = usuario
    ? new Date(usuario.creadoEn).toLocaleDateString('es-MX', { month: 'long', year: 'numeric' })
    : '';
        ...
        {loading ? <HeaderSkeleton /> : (
          <View style={styles.header}>
            ...
            <View style={styles.memberBadge}>
              ...
              <Text style={styles.memberBadgeText}>Miembro desde {miembroDesde}</Text>
            </View>
          </View>
        )}
...
const styles = StyleSheet.create({
  ...
  header:               { backgroundColor: Colors.navy, paddingHorizontal: Spacing['2xl'], paddingTop: Spacing.xl, paddingBottom: Spacing['3xl'], gap: Spacing.xl },
  ...
  avatar:               { width: 72, height: 72, borderRadius: 36, backgroundColor: Colors.yellow, alignItems: 'center', justifyContent: 'center' },
  avatarText:           { fontSize: FontSize['2xl'], fontWeight: FontWeight.bold, color: Colors.navy },
  memberBadge:          { flexDirection: 'row', alignItems: 'center', gap: Spacing.xs, paddingVertical: Spacing.md, paddingHorizontal: Spacing.lg, borderRadius: Radius.md, backgroundColor: 'rgba(255, 213, 0, 0.1)', alignSelf: 'flex-start' },
  ...
  puntosCard:           { marginHorizontal: Spacing.lg, marginTop: Spacing.lg, padding: Spacing.lg, borderRadius: Radius.xl, backgroundColor: Colors.navy },
  ...
  menuSection:          { paddingHorizontal: Spacing.lg, paddingTop: Spacing.lg, gap: Spacing.sm },
  menuItem:             { flexDirection: 'row', alignItems: 'center', padding: Spacing.lg, borderRadius: Radius.xl, backgroundColor: Colors.inputBackground, gap: Spacing.lg },
  menuItemIconWrap:     { width: 38, height: 38, borderRadius: Radius.md, backgroundColor: Colors.yellow, alignItems: 'center', justifyContent: 'center' },
  menuItemLabel:        { flex: 1, fontSize: FontSize.base, fontWeight: FontWeight.medium, color: Colors.navy },
  logoutButton:         { flexDirection: 'row', alignItems: 'center', marginHorizontal: Spacing.lg, marginTop: Spacing['2xl'], padding: Spacing.lg, borderRadius: Radius.xl, backgroundColor: Colors.navy, gap: Spacing.lg },
  logoutButtonDisabled: { opacity: 0.7 },
  logoutIconWrap:       { width: 38, height: 38, borderRadius: Radius.md, backgroundColor: 'rgba(255, 213, 0, 0.2)', alignItems: 'center', justifyContent: 'center' },
